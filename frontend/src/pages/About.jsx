  ...
  return (
    <div className="bg-gray-800 text-white rounded-lg shadow-md p-6 w-80 mx-auto">
      ...
      <div className="mt-6 space-y-4">
        ...
        {/* Date */}
        <div className="flex items-center space-x-3">
          <img src="/calender.png" alt="Calendar" className="w-6 h-6" />
        ...
        <div className="flex justify-between mt-4">
          <div className="flex items-center space-x-3">
            <img src="/income.png" alt="Amount" className="w-6 h-6" />
            <span>Rs. 20000</span>
          </div>
          <div className="flex items-center space-x-3">
            <img src="/donate.png" alt="Donate" className="w-6 h-6" />
            <span>Rs. 100</span>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex items-center space-x-3">
            <img src="/badge1.png" alt="Badge" className="w-11 h-11" />
            <img src="/badge2.png" alt="Badge" className="w-11 h-11" />
          </div>
        </div>
        
        <div className="flex items-center space-x-3">
          <img src="/idk.png" alt="Gallery" className="w-6 h-6" />
          <span>04</span>
        </div>
      </div>
    </div>
